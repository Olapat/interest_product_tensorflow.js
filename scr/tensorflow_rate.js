...
//แสดงผลลัพธ์ผ่าน console
// console.log(inputData);
// console.log(outputData);

//แบ่งข้อมูลออกเป็น 2 ประเภท ได้แก่ DataTrain และ DataTest
...
let optimizer = tf.train.adam(0.03);    
model.compile({
...
async function train() {
    ...
    await model.fit(xTrain, yTrain, {        //ข้อมูลสำหรับ Train
        ...
        callbacks: {                         //เพิ่มการทำงานในระหว่าง Train
            ...
            onEpochEnd: (e, l) => {                 
                console.log("รอบที่: ", e);   //แสดงจำนวนรอบผ่าน console
                //แสดงค่า loss ในรูปแบบทศนิยม 5 ตำแหน่ง และ ค่า acc ผ่าน console
                console.log("loss: ", l.loss.toFixed(5), '|', "acc: ", l.acc);      
            },
